...
export const getPosts = () => dispatch => {
  ...
  axios
    .get("https://my-tech-stuff-backend.herokuapp.com/api/post")
    .then(res => {
      console.log(res);
...
export const getPost = id => dispatch => {
  ...
  axios
    .get(`https://my-tech-stuff-backend.herokuapp.com/api/post/${id}`)
    .then(res => {
      console.log(res);
...
export const addPost = post => dispatch => {
  ...
  axios
    .post("https://my-tech-stuff-backend.herokuapp.com/api/post", post)
    .then(res => {
      console.log(res);
...
export const deletePost = id => dispatch => {
  ...
  axios
    .delete(`https://my-tech-stuff-backend.herokuapp.com/api/post/${id}`)
    .then(res => {
      console.log(res);
...
export const editPost = post => dispatch => {
  ...
  axios
    .put(
      `https://my-tech-stuff-backend.herokuapp.com/api/post/${post.id}`,
      post
    )
    .then(res => {
      console.log(res);
...
export const getProfile = id => dispatch => {
  ...
  axios
    .get(`https://my-tech-stuff-backend.herokuapp.com/api/user/${id}`)
    .then(res => {
...
export const editProfile = profile => dispatch => {
  ...
  axios
    .put(
      `https://my-tech-stuff-backend.herokuapp.com/api/user/${profile.id}`,
      profile
    )
    .then(res => {
...
export const signUp = userInfo => dispatch => {
  ...
  return axios
    .post("https://my-tech-stuff-backend.herokuapp.com/signup", userInfo)
    .then(res => {
...
export const toggleSignedIn = userInfo => dispatch => {
  ...
  return axios
    .post("https://my-tech-stuff-backend.herokuapp.com/signin", userInfo)
    .then(res => {
